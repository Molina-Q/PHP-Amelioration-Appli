            ...
            <?php 
                if(!isset($_SESSION['products']) || empty($_SESSION['products'])){
                            ...
                            echo "<tr>",
                                    ...
                                    "<td class='qttColumn'>",
                                        "<a href='traitement.php?action=qttRemoveOne&id=$index'><i class='fa-solid fa-minus'></i></a>",
                                            $product['qtt'],
                                        "<a href='traitement.php?action=qttAddOne&id=$index'><i class='fa-solid fa-plus'></a></i>",
                                    "</td>",
                                    "<td>".number_format($product['total'], 2, ",", "&nbsp;")."&nbsp;&euro;</td>",
                                    "<td class='deleteBtn'>",
                                        "<a href='traitement.php?action=deleteOne&id=$index'><i class='fa-solid fa-xmark'></i></a>",
                                    "</td>",
                                "</tr>";
                    ...
                    echo "<tr class='totalGeneral'>",
                            ...
                            "<td class='deleteBtn'><a href='traitement.php?action=deleteAll'><i class='fa-solid fa-xmark'></i></a></td>",
                        "</tr>",
                    "</tbody>",
                    "</table>";
                }
